...
def generate_response_for_raw_note_impl(generate_response_for_raw_note_request):  # noqa: E501
...
def transcribe_audio_for_note_impl(note_id=None, file_name=None):  # noqa: E501
